...
export default class CalendarController{
    ...
    static async loadTglAbsent(req,res){
        try {
            ...
            var dataParse = {start:start,end:end,employee_id:req.auth.employee_id};
            ...
            for (let index = 0; index < leaveData.length; index++) {
                ...
                var dataParse = {days:days,fromDate:fromDate,dateTo:dateTo,whereHolidayType:whereHolidayType,employee_id:req.auth.employee_id};
            ...
            var dataParse = {month:month,year:year,employee_id:req.auth.employee_id};
            let data = [];
            ...
            for (let index = 0; index < eventData.length; index++) {
                ...
                if (month == holDate) {
                    ...
                    if (!eventResult.IDAbsent) {
                        ...
                        if (eventResult.justificationRemarks !== null) {
                            ...
                            const starTime_plus15 = new Date(eventResult.StartTime);
                            starTime_plus15.setMinutes(starTime_plus15.getMinutes() + 15);
    ...
    static async addJustification(req,res){
        try{
            ...
            if(absent){
                ...
                await AbsentRepository.update(req,dataParam,{IdAbsent : absent.data.IdAbsent})
            }else{
                //lupa absent
                const dataParam = {
